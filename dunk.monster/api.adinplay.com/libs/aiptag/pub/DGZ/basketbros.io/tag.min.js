...
aiptag.settings = {
	sVersion: '7.0',
	sUpdated: 'Wednesday 12 April 2023 - 11:07',
	sPubName: 'DGZ',
	sSellerId: 'SSK',
	sPubUrl: 'basketbros.io',
	sAdUnitVideo: 'basketbros.io_preroll',
	sAdBreakChannel: '7422876987',
	sAdUnitAudio: '',
	sAdUnitInterstitial: '',
	...
	iTimeoutPlayer: 8000,
	sNetworkIdRewarded: '421469808,21743024831',
	...
	iMCM: true,
	iMCMiD: '21743024831',
	sNetworkIdVideo: '421469808,21743024831',
	iAmazonVideoAds: false,
	sNetworkIdDisplay: '421469808,21743024831',
...
function aipAPI() {
	...
	if(aiptag.settings.sAdUnitVideo) {
		...
		this.videoAdUnit["basketbros.io_preroll"] = {
code: 'prerollUnit',
mediaTypes: {
	video: {
		context: 'instream',
...
};this.videoAdUnitMaxDuration["basketbros.io_preroll"] = "30000";this.videoAdUnitSkipButtonTimeout["basketbros.io_preroll"] = false;this.videoAdUnit["basketbros.io_preroll_15s"] = {
code: 'prerollUnit',
mediaTypes: {
	video: {
		context: 'instream',
...
bids: [
	...
	},
	{
...
};this.videoAdUnitMaxDuration["basketbros.io_preroll_15s"] = "15000";this.videoAdUnitSkipButtonTimeout["basketbros.io_preroll_15s"] = "17000";	}

			this.adUnits['basketbros-io_300x250'] = [{
		code: 'basketbros-io_300x250',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					...
					ext: { placement_name: 'basketbros.io_300x250'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '18673708'
				}
			},
			{
				bidder: 'pubmatic',
			...
			},
			{
				bidder: 'triplelift',
				params: {
					inventoryCode: 'Adinplay_basketbros_io_300x250_pb'
				}
			},
			{
				bidder: 'unruly',
		...
		this.adSlots['basketbros-io_300x250'] = {adunit: 'basketbros.io_300x250', sizes: [300, 250], reload: true, autoRefresh: true, autoRefreshTimer: 30000, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_300x250'] = [{slotID: 'basketbros-io_300x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_300x250', sizes: [[300, 250]]}];
		}
		this.requestManager['basketbros-io_300x250'] = {adserverRequestSent: false, aps: false, prebid: false};

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['basketbros-io_300x250'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['basketbros-io_300x250'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['basketbros-io_300x250'].autoRefreshHasFocus+" for: "+this.adSlots['basketbros-io_300x250'].adunit);
			} catch(e){}
			*/
					this.adUnits['basketbros-io_300x250_2'] = [{
		code: 'basketbros-io_300x250_2',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_300x250_2'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '18673712'
				}
			},
			{
				bidder: 'pubmatic',
		...
		this.adSlots['basketbros-io_300x250_2'] = {adunit: 'basketbros.io_300x250_2', sizes: [300, 250], reload: true, autoRefresh: true, autoRefreshTimer: 30000, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_300x250_2'] = [{slotID: 'basketbros-io_300x250_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_300x250_2', sizes: [[300, 250]]}];
		}
		this.requestManager['basketbros-io_300x250_2'] = {adserverRequestSent: false, aps: false, prebid: false};

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['basketbros-io_300x250_2'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['basketbros-io_300x250_2'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['basketbros-io_300x250_2'].autoRefreshHasFocus+" for: "+this.adSlots['basketbros-io_300x250_2'].adunit);
			} catch(e){}
			*/
					this.adUnits['basketbros-io_728x90'] = [{
		code: 'basketbros-io_728x90',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_728x90'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '18673714'
				}
			},
			{
				bidder: 'pubmatic',
			...
			},
			{
				bidder: 'triplelift',
				params: {
					inventoryCode: 'Adinplay_basketbros_io_728x90_pb'
				}
			},
			{
				bidder: 'unruly',
		...
		this.adSlots['basketbros-io_728x90'] = {adunit: 'basketbros.io_728x90', sizes: [728, 90], reload: true, autoRefresh: true, autoRefreshTimer: 30000, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_728x90'] = [{slotID: 'basketbros-io_728x90', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_728x90', sizes: [[728, 90]]}];
		}
		this.requestManager['basketbros-io_728x90'] = {adserverRequestSent: false, aps: false, prebid: false};

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['basketbros-io_728x90'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['basketbros-io_728x90'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['basketbros-io_728x90'].autoRefreshHasFocus+" for: "+this.adSlots['basketbros-io_728x90'].adunit);
			} catch(e){}
			*/
					this.adUnits['basketbros-io_player_300x600'] = [{
		code: 'basketbros-io_player_300x600',
		mediaTypes: {
			banner: {
				sizes: [300, 600]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_player_300x600'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '24592192'
				}
			},
			{
				bidder: 'pubmatic',
			...
			},
			{
				bidder: 'triplelift',
				params: {
					inventoryCode: 'Adinplay_basketbros_io_player_300x600_pb'
				}
			},
			{
				bidder: 'unruly',
		...
		this.adSlots['basketbros-io_player_300x600'] = {adunit: 'basketbros.io_player_300x600', sizes: [300, 600], reload: true, autoRefresh: true, autoRefreshTimer: 30000, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_player_300x600'] = [{slotID: 'basketbros-io_player_300x600', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_player_300x600', sizes: [[300, 600]]}];
		}
		this.requestManager['basketbros-io_player_300x600'] = {adserverRequestSent: false, aps: false, prebid: false};

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['basketbros-io_player_300x600'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['basketbros-io_player_300x600'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['basketbros-io_player_300x600'].autoRefreshHasFocus+" for: "+this.adSlots['basketbros-io_player_300x600'].adunit);
			} catch(e){}
			*/
					this.adUnits['basketbros-io_970x250'] = [{
		code: 'basketbros-io_970x250',
		mediaTypes: {
			banner: {
				sizes: [970, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_970x250'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '25167761'
				}
			},
			{
				bidder: 'pubmatic',
		...
		this.adSlots['basketbros-io_970x250'] = {adunit: 'basketbros.io_970x250', sizes: [970, 250], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_970x250'] = [{slotID: 'basketbros-io_970x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_970x250', sizes: [[970, 250]]}];
		}
		this.requestManager['basketbros-io_970x250'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['basketbros-io_728x90_m'] = [{
		code: 'basketbros-io_728x90_m',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_728x90_m'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '25168029'
				}
			},
			{
				bidder: 'pubmatic',
		...
		this.adSlots['basketbros-io_728x90_m'] = {adunit: 'basketbros.io_728x90_m', sizes: [728, 90], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_728x90_m'] = [{slotID: 'basketbros-io_728x90_m', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_728x90_m', sizes: [[728, 90]]}];
		}
		this.requestManager['basketbros-io_728x90_m'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['basketbros-io_300x600_m'] = [{
		code: 'basketbros-io_300x600_m',
		mediaTypes: {
			banner: {
				sizes: [300, 600]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_300x600_m'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '25168036'
				}
			},
			{
				bidder: 'pubmatic',
		...
		this.adSlots['basketbros-io_300x600_m'] = {adunit: 'basketbros.io_300x600_m', sizes: [300, 600], reload: true, autoRefresh: false, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_300x600_m'] = [{slotID: 'basketbros-io_300x600_m', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_300x600_m', sizes: [[300, 600]]}];
		}
		this.requestManager['basketbros-io_300x600_m'] = {adserverRequestSent: false, aps: false, prebid: false};

				this.adUnits['basketbros-io_160x600'] = [{
		code: 'basketbros-io_160x600',
		mediaTypes: {
			banner: {
				sizes: [160, 600]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_160x600'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '25168058'
				}
			},
			{
				bidder: 'pubmatic',
			...
			},
			{
				bidder: 'triplelift',
				params: {
					inventoryCode: 'Adinplay_basketbros_io_160x600_pb'
				}
			},
			{
				bidder: 'unruly',
		...
		this.adSlots['basketbros-io_160x600'] = {adunit: 'basketbros.io_160x600', sizes: [160, 600], reload: true, autoRefresh: true, autoRefreshTimer: 30000, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: {
		tagId: '86835',
		width: '160',
		height: '600'
	}};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_160x600'] = [{slotID: 'basketbros-io_160x600', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_160x600', sizes: [[160, 600]]}];
		}
		this.requestManager['basketbros-io_160x600'] = {adserverRequestSent: false, aps: false, prebid: false};

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['basketbros-io_160x600'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['basketbros-io_160x600'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['basketbros-io_160x600'].autoRefreshHasFocus+" for: "+this.adSlots['basketbros-io_160x600'].adunit);
			} catch(e){}
			*/
					this.adUnits['basketbros-io_160x600_2'] = [{
		code: 'basketbros-io_160x600_2',
		mediaTypes: {
			banner: {
				sizes: [160, 600]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'basketbros.io_160x600_2'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '26576059'
				}
			},
			{
				bidder: 'pubmatic',
		...
		this.adSlots['basketbros-io_160x600_2'] = {adunit: 'basketbros.io_160x600_2', sizes: [160, 600], reload: true, autoRefresh: true, autoRefreshTimer: 30000, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: false, cpmstar: {
		tagId: '86836',
		width: '160',
		height: '600'
	}};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['basketbros-io_160x600_2'] = [{slotID: 'basketbros-io_160x600_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/basketbros.io_160x600_2', sizes: [[160, 600]]}];
		}
		this.requestManager['basketbros-io_160x600_2'] = {adserverRequestSent: false, aps: false, prebid: false};

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['basketbros-io_160x600_2'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['basketbros-io_160x600_2'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['basketbros-io_160x600_2'].autoRefreshHasFocus+" for: "+this.adSlots['basketbros-io_160x600_2'].adunit);
			} catch(e){}
			*/
	...
	*/
	...
	if(aRemoveBidders.length > 0) {
		//removeBidders from display
					this.removeBidders(this.adUnits['basketbros-io_300x250'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_300x250_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_728x90'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_player_300x600'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_970x250'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_728x90_m'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_300x600_m'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_160x600'], aRemoveBidders);
					this.removeBidders(this.adUnits['basketbros-io_160x600_2'], aRemoveBidders);
		
		//removeBidders from preroll
							this.removeBidders([this.videoAdUnit["basketbros.io_preroll"]], aRemoveBidders);
										this.removeBidders([this.videoAdUnit["basketbros.io_preroll_15s"]], aRemoveBidders);
						}
}

aipAPI.prototype.cutomSizeConfig = function() {
		try {
		this.adSlots['basketbros-io_player_300x600']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];
		this.adUnits['basketbros-io_player_300x600'][0]['mediaTypes']['banner']['sizes'] = [[300, 600], [300, 250], [160, 600], [120, 600]];
		
		this.adSlots['basketbros-io_160x600']['sizes'] = [[160, 600], [120, 600]];
		this.adUnits['basketbros-io_160x600'][0]['mediaTypes']['banner']['sizes'] = [[160, 600], [120, 600]];
		
		this.adSlots['basketbros-io_160x600_2']['sizes'] = [[160, 600], [120, 600]];
		this.adUnits['basketbros-io_160x600_2'][0]['mediaTypes']['banner']['sizes'] = [[160, 600], [120, 600]];

		this.adSlots['basketbros-io_300x600_m']['sizes'] = [[300, 600], [160, 600], [120, 600]];
		this.adUnits['basketbros-io_300x600_m'][0]['mediaTypes']['banner']['sizes'] = [[300, 600], [160, 600], [120, 600]];

		this.adSlots['basketbros-io_970x250']['sizes'] = [[970, 250], [970, 90], [750, 200], [728, 90]];
		this.adUnits['basketbros-io_970x250'][0]['mediaTypes']['banner']['sizes'] = [[970, 250], [970, 90], [750, 200], [728, 90]];

		this.adSlots['basketbros-io_728x90_m']['sizes'] = [[728, 90], [468, 60], [234, 60]];
		this.adUnits['basketbros-io_728x90_m'][0]['mediaTypes']['banner']['sizes'] = [[728, 90], [468, 60], [234, 60]];

		document.getElementById("basketbros-io_160x600_2").style.maxWidth = "160px";
		document.getElementById("basketbros-io_160x600_2").style.maxHeight = "600px";
	...
	try {
		...
		rawFile.onreadystatechange = function() {
			if (rawFile.readyState === 4) {
				...
				var aip_id = "DGZ/basketbros.io";
				var seller_id_js = "SSK";
				var mcm_js = "21743024831";
...
aipAPI.prototype.initAdblock=function(){if(!0===aiptag.settings.iBtLoader){var a=document.createElement("script");a.async=!0;a.type="text/javascript";a.src="https://btloader.com/tag?o=5130683165442048&upapi=true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}};
...
aipAPI.prototype.initGDPR=function(){function a(h,e,f,g,l){"undefined"===typeof l&&(l="/");"undefined"===typeof g?(g=(window&&window.location&&window.location.hostname||"").split("."),g=";domain="+(1<g.length?g.slice(-2).join("."):"")):g="";var p=new Date;p.setSeconds(p.getSeconds()+f);document.cookie=h+" = "+e+g+";path="+l+";max-age="+f+";Expires="+p.toUTCString()}function b(){try{var h=new CustomEvent("aip_consentnotrequired");document.dispatchEvent(h)}catch(e){aipAPItag.logError(e)}}function c(){aipAPItag.CMPloadTimeout=
setTimeout(function(){aipAPItag.log("AIP Ads started after CMP timeout");b()},aipAPItag.timeout_cmp);var h=document.createElement("link");h.type="text/css";h.rel="stylesheet";h.async=!0;h.href="https://cdn.consentmanager.mgr.consensu.org/delivery/cmp.min.css";document.getElementsByTagName("head")[0].appendChild(h);window.gdprAppliesGlobally=!1;window.cmp_target="_blank";window.cmp_stayiniframe=1;window.cmp_logoclick="https://adinplay.com/?utm_source=publishers&utm_medium=cmp";"min"===aiptag.cmp.position?
(window.cmp_id=56102,window.cmp_cdid="93be383f94a9",window.cmp_host="c.delivery.consentmanager.net",window.cmp_logoclick=""):"bottom"===aiptag.cmp.position?(window.cmp_id=15920,window.cmp_cdid="0d3e4b95c303",window.cmp_host="a.delivery.consentmanager.net"):(window.cmp_id=13566,window.cmp_cdid="abbb821549a1",window.cmp_host="c.delivery.consentmanager.net");if(!("cmp_id"in window)||1>window.cmp_id)window.cmp_id=0;"cmp_cdid"in window||(window.cmp_cdid="abbb821549a1");"cmp_params"in window||(window.cmp_params=
"");"cmp_host"in window||(window.cmp_host="c.delivery.consentmanager.net");"cmp_cdn"in window||(window.cmp_cdn="cdn.consentmanager.net");"cmp_proto"in window||(window.cmp_proto="https:");"cmp_codesrc"in window||(window.cmp_codesrc="1");window.cmp_getsupportedLangs=function(){var e="DE EN FR IT NO DA FI ES PT RO BG ET EL GA HR LV LT MT NL PL SV SK SL CS HU RU SR ZH TR UK AR BS".split(" ");if("cmp_customlanguages"in window)for(var f=0;f<window.cmp_customlanguages.length;f++)e.push(window.cmp_customlanguages[f].l.toUpperCase());
return e};window.cmp_getRTLLangs=function(){return["AR"]};window.cmp_getlang=function(e){"boolean"!=typeof e&&(e=!0);if(e&&"string"==typeof cmp_getlang.usedlang&&""!==cmp_getlang.usedlang)return cmp_getlang.usedlang;e=window.cmp_getsupportedLangs();var f=[],g=location.hash,l=location.search,p="languages"in navigator?navigator.languages:[];if(-1!=g.indexOf("cmplang="))f.push(g.substr(g.indexOf("cmplang=")+8,2).toUpperCase());else if(-1!=l.indexOf("cmplang="))f.push(l.substr(l.indexOf("cmplang=")+8,
2).toUpperCase());else if("cmp_setlang"in window&&""!=window.cmp_setlang)f.push(window.cmp_setlang.toUpperCase());else if(0<p.length)for(g=0;g<p.length;g++)f.push(p[g]);"language"in navigator&&f.push(navigator.language);"userLanguage"in navigator&&f.push(navigator.userLanguage);p="";for(g=0;g<f.length;g++){l=f[g].toUpperCase();if(-1!=e.indexOf(l)){p=l;break}-1!=l.indexOf("-")&&(l=l.substr(0,2));if(-1!=e.indexOf(l)){p=l;break}}if(""==p&&"string"==typeof cmp_getlang.defaultlang&&""!==cmp_getlang.defaultlang)return cmp_getlang.defaultlang;
""==p&&(p="EN");return p=p.toUpperCase()};(function(){function e(w,F){w+="=";var A=w.length;if(-1!=location.hash.indexOf(w))A=location.hash.substr(location.hash.indexOf(w)+A,9999);else if(-1!=location.search.indexOf(w))A=location.search.substr(location.search.indexOf(w)+A,9999);else return F;-1!=A.indexOf("&")&&(A=A.substr(0,A.indexOf("&")));return A}var f=document,g=window,l="",p="_en";if("cmp_getlang"in g){l=g.cmp_getlang().toLowerCase();if("cmp_customlanguages"in g)for(var q=0;q<g.cmp_customlanguages.length;q++)if(g.cmp_customlanguages[q].l.toUpperCase()==
l.toUpperCase()){l="en";break}p="_"+l}var y="cmp_proto"in g?g.cmp_proto:"https:",n=["cmp_id","cmp_params","cmp_host","cmp_cdn","cmp_proto"];for(q=0;q<n.length;q++)"%%%"!=e(n[q],"%%%")&&(window[n[q]]=e(n[q],""));n="cmp_ref"in g?g.cmp_ref:location.href;q=f.createElement("script");q.setAttribute("data-cmp-ab","1");var x=e("cmpdesign",""),t=e("cmpregulationkey","");q.src=y+"//"+g.cmp_host+"/delivery/cmp.php?"+("cmp_id"in g&&0<g.cmp_id?"id="+g.cmp_id:"")+("cmp_cdid"in g?"cdid="+g.cmp_cdid:"")+"&h="+encodeURIComponent(n)+
(""!=x?"&cmpdesign="+encodeURIComponent(x):"")+(""!=t?"&cmpregulationkey="+encodeURIComponent(t):"")+("cmp_params"in g?"&"+g.cmp_params:"")+(0<f.cookie.length?"&__cmpfcc=1":"")+"&l="+l.toLowerCase()+"&o="+(new Date).getTime();q.type="text/javascript";q.async=!0;f.currentScript?f.currentScript.parentElement.appendChild(q):f.body?f.body.appendChild(q):(l=f.getElementsByTagName("body"),0==l.length&&(l=f.getElementsByTagName("div")),0==l.length&&(l=f.getElementsByTagName("span")),0==l.length&&(l=f.getElementsByTagName("ins")),
0==l.length&&(l=f.getElementsByTagName("script")),0==l.length&&(l=f.getElementsByTagName("head")),0<l.length&&l[0].appendChild(q));q=f.createElement("script");q.src=y+"//"+g.cmp_cdn+"/delivery/js/cmp"+p+".min.js";q.type="text/javascript";q.setAttribute("data-cmp-ab","1");q.async=!0;f.currentScript?f.currentScript.parentElement.appendChild(q):f.body?f.body.appendChild(q):(l=f.getElementsByTagName("body"),0==l.length&&(l=f.getElementsByTagName("div")),0==l.length&&(l=f.getElementsByTagName("span")),
0==l.length&&(l=f.getElementsByTagName("ins")),0==l.length&&(l=f.getElementsByTagName("script")),0==l.length&&(l=f.getElementsByTagName("head")),0<l.length&&l[0].appendChild(q))})();window.cmp_addFrame=function(e){if(!window.frames[e])if(document.body){var f=document.createElement("iframe");f.style.cssText="display:none";f.name=e;document.body.appendChild(f)}else window.setTimeout(window.cmp_addFrame,10,e)};window.cmp_rc=function(e){for(var f=document.cookie,g="",l=0;""!=f&&100>l;){for(l++;" "==f.substr(0,
1);)f=f.substr(1,f.length);var p=f.substring(0,f.indexOf("=")),q=-1!=f.indexOf(";")?f.substring(f.indexOf("=")+1,f.indexOf(";")):f.substr(f.indexOf("=")+1,f.length);e==p&&(g=q);p=f.indexOf(";")+1;0==p&&(p=f.length);f=f.substring(p,f.length)}return g};window.cmp_stub=function(){var e=arguments;__cmp.a=__cmp.a||[];if(e.length)if("ping"===e[0])if(2===e[1])e[2]({gdprApplies:gdprAppliesGlobally,cmpLoaded:!1,cmpStatus:"stub",displayStatus:"hidden",apiVersion:"2.0",cmpId:31},!0);else e[2](!1,!0);else if("getUSPData"===
e[0])e[2]({version:1,uspString:window.cmp_rc("")},!0);else if("getTCData"===e[0])__cmp.a.push([].slice.apply(e));else if("addEventListener"===e[0]||"removeEventListener"===e[0])__cmp.a.push([].slice.apply(e));else if(4==e.length&&!1===e[3])e[2]({},!1);else __cmp.a.push([].slice.apply(e));else return __cmp.a};window.cmp_msghandler=function(e){var f="string"===typeof e.data;try{var g=f?JSON.parse(e.data):e.data}catch(p){g=null}if("object"===typeof g&&null!==g&&"__cmpCall"in g){var l=g.__cmpCall;window.__cmp(l.command,
l.parameter,function(p,q){var y={__cmpReturn:{returnValue:p,success:q,callId:l.callId}};e.source.postMessage(f?JSON.stringify(y):y,"*")})}"object"===typeof g&&null!==g&&"__uspapiCall"in g&&(l=g.__uspapiCall,window.__uspapi(l.command,l.version,function(p,q){var y={__uspapiReturn:{returnValue:p,success:q,callId:l.callId}};e.source.postMessage(f?JSON.stringify(y):y,"*")}));"object"===typeof g&&null!==g&&"__tcfapiCall"in g&&(l=g.__tcfapiCall,window.__tcfapi(l.command,l.version,function(p,q){var y={__tcfapiReturn:{returnValue:p,
success:q,callId:l.callId}};e.source.postMessage(f?JSON.stringify(y):y,"*")},l.parameter))};window.cmp_setStub=function(e){e in window&&("function"===typeof window[e]||"object"===typeof window[e]||"undefined"!==typeof window[e]&&null===window[e])||(window[e]=window.cmp_stub,window[e].msgHandler=window.cmp_msghandler,window.addEventListener("message",window.cmp_msghandler,!1))};window.cmp_addFrame("__cmpLocator");"cmp_disableusp"in window&&window.cmp_disableusp||window.cmp_addFrame("__uspapiLocator");
"cmp_disabletcf"in window&&window.cmp_disabletcf||window.cmp_addFrame("__tcfapiLocator");window.cmp_setStub("__cmp");"cmp_disabletcf"in window&&window.cmp_disabletcf||window.cmp_setStub("__tcfapi");"cmp_disableusp"in window&&window.cmp_disableusp||window.cmp_setStub("__uspapi");aipAPItag.log("consentManagement setConfig init");aip_pbjs.que.push(function(){aip_pbjs.setConfig({consentManagement:{gdpr:{cmpApi:"iab",timeout:1E3,defaultGdprScope:!0}}})});__cmp("addEventListener",["consent",function(e,
f){aipAPItag.log("Consent received");var g="Privacy settings";aiptag.cmp.buttonText&&(g=aiptag.cmp.buttonText);var l="none";!0===aiptag.cmp.button&&(l="block");var p="bottom: 0px;left: 0px;border-top-left-radius: 3px;border-top-right-radius: 3px;";"bottom-right"==aiptag.cmp.buttonPosition&&(p="bottom: 0px;right: 0px;border-top-left-radius: 3px;border-top-right-radius: 3px;");"top-right"==aiptag.cmp.buttonPosition&&(p="top: 0px;right: 0px;border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;");
"top-left"==aiptag.cmp.buttonPosition&&(p="top: 0px;left: 0px;border-bottom-left-radius: 3px;border-bottom-right-radius: 3px;");try{if(!aipAPItag.isInPage(document.getElementById("cmpPersistentLink"))){var q=document.createElement("div");document.getElementsByTagName("body")[0].appendChild(q);q.id="cmpPersistentLink";q.style.display=l;q.innerHTML='<a href="#" onclick="aipAPItag.showCMPScreen();return false;" class="cmp-persistent-link" style="font-size: 16px;line-height: 1.2;text-decoration: none;cursor: pointer; position: fixed; background-color: #3d657c; padding: 5px 15px; color: #ffffff; display: flex; z-index: 999994;'+
p+'"><svg width="16px" height="17px" viewBox="0 0 16 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin-right: 5px; height: 17px;"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="cog" fill="#FFFFFF" fill-rule="nonzero"><path d="M15.596917,9.98326938 L14.5041079,9.33798816 C14.5728064,8.7815386 14.5728064,8.2184614 14.5041079,7.66201184 L15.596917,7.01673062 C15.9178229,6.82726259 16.0726124,6.43742732 15.9670848,6.0741546 C15.5912871,4.78033611 14.9223646,3.61573153 14.0390021,2.66061113 C13.7831755,2.38401797 13.3749053,2.32348965 13.0525249,2.51384881 L11.9613243,3.15813608 C11.5248519,2.81840117 11.0481221,2.53648663 10.542482,2.31910255 L10.542482,1.02991108 C10.542482,0.648438733 10.2860522,0.316869683 9.92305592,0.229024792 C8.66155,-0.07632446 7.33871809,-0.0763587342 6.07694408,0.229024792 C5.71398131,0.316869683 5.457518,0.648404458 5.457518,1.02991108 L5.457518,2.31910255 C4.95187406,2.53647872 4.47514334,2.81839382 4.03867572,3.15813608 L2.94747511,2.51384881 C2.62506122,2.32348965 2.21679094,2.38401797 1.96099786,2.66061113 C1.07763542,3.61573153 0.40871289,4.78037038 0.0329152236,6.0741546 C-0.072612407,6.43742732 0.0821770899,6.82722832 0.403082962,7.01673062 L1.49589212,7.66201184 C1.42719356,8.2184614 1.42719356,8.7815386 1.49589212,9.33798816 L0.403082962,9.98326938 C0.0821770899,10.1727374 -0.072612407,10.5625727 0.0329152236,10.9258454 C0.40871289,12.2196296 1.07763542,13.3842685 1.96099786,14.3393889 C2.21682445,14.615982 2.62509474,14.6765103 2.94747511,14.4861855 L4.03867572,13.8418982 C4.47514096,14.1816349 4.95187243,14.4635389 5.457518,14.6808975 L5.457518,15.9700889 C5.457518,16.3515613 5.7139478,16.6831303 6.07694408,16.7709752 C7.33848351,17.0763245 8.66128191,17.0763587 9.92305592,16.7709752 C10.2860187,16.6831303 10.542482,16.3515955 10.542482,15.9700889 L10.542482,14.6808975 C11.0481183,14.4635198 11.5248475,14.1816171 11.9613243,13.8418982 L13.0525249,14.4861855 C13.3749053,14.6765446 13.7831755,14.6160163 14.0390021,14.3393889 C14.9223646,13.3842685 15.5912871,12.2196296 15.9670848,10.9258454 C16.0726124,10.5625727 15.9178229,10.1727717 15.596917,9.98326938 Z M13.4026193,13.4264943 L11.8507364,12.510001 C10.9463288,13.3007421 10.6255905,13.4997041 9.47011484,13.9172673 L9.47011484,15.7502196 C8.50024808,15.9548373 7.49975192,15.9548373 6.52988516,15.7502196 L6.52988516,13.9172673 C5.4031959,13.5101235 5.07699522,13.3210668 4.14926358,12.510001 L2.59738075,13.4264943 C1.9368696,12.6693763 1.43490124,11.7817076 1.12525522,10.8230912 L2.67780828,9.90659789 C2.4588108,8.69270694 2.45871027,8.30790999 2.67780828,7.09340211 L1.12525522,6.17690879 C1.43490124,5.21829242 1.93690311,4.33058946 2.59738075,3.57312864 L4.14926358,4.49030745 C5.0667072,3.68712478 5.39129933,3.4941265 6.52988516,3.08269846 L6.52988516,1.24978037 C7.49971774,1.04482059 8.50028226,1.04482059 9.47011484,1.24978037 L9.47011484,3.08273274 C10.6087677,3.49419505 10.9333933,3.6872276 11.8507364,4.49034172 L13.4026193,3.57316291 C14.0630969,4.33058946 14.5650988,5.21829242 14.8747448,6.17694306 L13.3221917,7.09343638 C13.5412227,8.3076358 13.5412897,8.69212428 13.3221917,9.90663217 L14.8747448,10.8231255 C14.5650988,11.7817076 14.0631304,12.6694105 13.4026193,13.4264943 Z M8,5.20968958 C6.22607014,5.20968958 4.78289853,6.68570996 4.78289853,8.50001714 C4.78289853,10.3143243 6.22607014,11.7903447 8,11.7903447 C9.77392986,11.7903447 11.2171015,10.3143243 11.2171015,8.50001714 C11.2171015,6.68570996 9.77392986,5.20968958 8,5.20968958 Z M8,10.6935688 C6.81738009,10.6935688 5.85526568,9.70955526 5.85526568,8.50001714 C5.85526568,7.29047902 6.81738009,6.30646543 8,6.30646543 C9.18261991,6.30646543 10.1447343,7.29047902 10.1447343,8.50001714 C10.1447343,9.70955526 9.18261991,10.6935688 8,10.6935688 Z" id="Shape"></path></g></g></svg>'+
g+"</a>"}}catch(w){aipAPItag.logError(w)}try{var y=new CustomEvent("aip_consent",{detail:{eventname:e,cmpobject:f}});document.dispatchEvent(y);var n=__cmp("getCMPData");if("vendorConsents"in n)if("755"in n.vendorConsents&&n.vendorConsents["755"])try{var x=new CustomEvent("aip_consentapproved",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(x)}catch(w){aipAPItag.logError(w)}else try{var t=new CustomEvent("aip_consentrejected",{detail:{eventname:void 0,cmpobject:void 0}});document.dispatchEvent(t)}catch(w){aipAPItag.logError(w)}}catch(w){aipAPItag.logError(w)}},
!1],null);__cmp("addEventListener",["init",function(e,f){try{var g=new CustomEvent("aip_consentinit",{detail:{eventname:e,cmpobject:f}});document.dispatchEvent(g)}catch(l){aipAPItag.logError(l)}},!1],null);__cmp("addEventListener",["settings",function(e,f){try{clearTimeout(aipAPItag.CMPloadTimeout)}catch(l){aipAPItag.logError(l)}try{var g=new CustomEvent("aip_consentsettings",{detail:{eventname:e,cmpobject:f}});document.dispatchEvent(g)}catch(l){aipAPItag.logError(l)}},!1],null);__cmp("addEventListener",
["consentscreen",function(e,f){try{var g=new CustomEvent("aip_consentscreen",{detail:{eventname:e,cmpobject:f}});document.dispatchEvent(g)}catch(l){aipAPItag.logError(l)}},!1],null);__cmp("addEventListener",["consentscreenoff",function(e,f){try{var g=new CustomEvent("aip_consentscreenoff",{detail:{eventname:e,cmpobject:f}});document.dispatchEvent(g)}catch(l){aipAPItag.logError(l)}},!1],null);__cmp("addEventListener",["liestablished",function(e,f){try{var g=new CustomEvent("aip_consentliestablished",
{detail:{eventname:e,cmpobject:f}});document.dispatchEvent(g)}catch(l){aipAPItag.logError(l)}},!1],null)}if(!0===aiptag.cmp.show)if(aipAPItag.log("aiptag.cmp.show = true"),"true"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=true, user from EEA, GDPR Consent required"),c();else if("false"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=false, user not from EEA, GDPR Consent not required"),b();else{var d=new XMLHttpRequest;d.onreadystatechange=function(){if(d.readyState==
XMLHttpRequest.DONE)if(200==d.status){var h="";try{h=d.responseText.toUpperCase()}catch(f){aipAPItag.logError(f)}a("CountryCode",h,"7889229");aipAPItag.CountryCode=h;var e="AT AX BE BG CY CZ DE DK EE ES EU FI FR GB GF GI GP GR HR HU IE IS IT LI LT LU LV ME MF MQ MT NL NO PL PT RE RO SE SI SK YT".split(" ");try{"min"===aiptag.cmp.position&&e.push("US")}catch(f){}0<=e.indexOf(h)?(a("userFromEEA","true","7889229"),aipAPItag.userFromEEA="true",aipAPItag.log("GDPR Consent required for "+h),c()):(a("userFromEEA",
"false","7889229"),aipAPItag.userFromEEA="false",aipAPItag.log("GDPR Consent not required for "+h),b())}else aipAPItag.log("Unknown geo-targeting issue, assuming user is not from EEA"),aipAPItag.userFromEEA="false",b()};d.ontimeout=function(h){aipAPItag.log("Geo-targeting timeout occured, assuming user is not from EEA");aipAPItag.userFromEEA="false";b()};d.open("GET","https://country.adinplay.workers.dev/",!0);d.timeout=500;d.send()}else aipAPItag.log("aiptag.cmp.show = false, or not set"),b()};
...
aipAPI.prototype.getDebug=function(){var a=!1;try{this.validateQueryParams("aipdebug","false")?localStorage.setItem("aipdebug","false"):(a=this.validateQueryParams("aipdebug"))?localStorage.setItem("aipdebug","true"):"true"===localStorage.getItem("aipdebug")&&(a=!0)}catch(b){}return a};aipAPI.prototype.validateQueryParams=function(a,b){try{var c="=";b||(c=b="");return-1!==(window.location!=window.parent.location?document.referrer:document.location.href).indexOf(a+c+b)?!0:!1}catch(d){aipAPItag.logError(d)}};
aipAPI.prototype.urlParamUpdate=function(a,b,c,d){var h=new RegExp("[\\?&]"+b+"=([^&#]*)","i"),e=h.exec(a);if(null===e)d=/\?/.test(a),a=a+(d?"&":"?")+b+"="+c;else{var f=e[0].charAt(0);a=!0===d?a.replace(h,f+b+"="+e[1]+"%26"+c):a.replace(h,f+b+"="+c)}return a};
...
aipAPI.prototype.setConfirmedClick=function(a){var b=JSON.parse(sessionStorage.getItem("ConfirmedClick"))||[];b.includes(a)||b.push(a);sessionStorage.setItem("ConfirmedClick",JSON.stringify(b))};aipAPI.prototype.unsetConfirmedClick=function(a){var b=JSON.parse(sessionStorage.getItem("ConfirmedClick"))||[];a=b.indexOf(a);-1<a&&b.splice(a,1);sessionStorage.setItem("ConfirmedClick",JSON.stringify(b))};
aipAPI.prototype.getConfirmedClick=function(a){return(JSON.parse(sessionStorage.getItem("ConfirmedClick"))||[]).includes(a)?!0:!1};
...
try{c=new CustomEvent("aip_interstitialadavailable"),document.dispatchEvent(c)}catch(d){aipAPItag.logError(d)}}}),googletag.pubads().disableInitialLoad(),googletag.enableServices(),googletag.display(b),googletag.pubads().refresh([b])):aipAPItag.log("Interstitial is not supported")})};
...
(aipAPItag.setConfirmedClick(d),aipAPItag.sendLogClick(d),aipAPItag.log("Confirmed click detected on "+d))}catch(q){}if(aipAPItag.adSlots.hasOwnProperty(b)){if(!0===a.isEmpty){var h=aip_pbjs.getAdserverTargetingForAdUnitCode([b]);if(h&&h.hb_adid){aipAPItag.log("Custom fallback for: "+b);var e=h.hb_size.split("x")[0],f=h.hb_size.split("x")[1];document.getElementById(b).innerHTML="";var g=document.createElement("iframe");g.width=e;g.height=f;g.border="0px";g.hspace="0";g.vspace="0";g.marginWidth="0";
g.marginHeight="0";g.style.border="0";g.scrolling="no";g.frameBorder="0";g.src="about:blank";document.getElementById(b).appendChild(g);aipAPItag.log("--------------");aipAPItag.log(b);aipAPItag.log(h);aipAPItag.log(aip_pbjs.getHighestCpmBids([b]));aipAPItag.log("getAdserverTargetingForAdUnitCode: "+h.hb_adid);aipAPItag.log("getHighestCpmBids: "+aip_pbjs.getHighestCpmBids([b])[0].adId);aip_pbjs.renderAd(g.contentDocument,h.hb_adid)}else if(aipAPItag.adSlots[b]&&aipAPItag.adSlots[b].cpmstar&&aipAPItag.adSlots[b].cpmstar.tagId){var l=
aipAPItag.adSlots[b].cpmstar.tagId;aipAPItag.log("CPMStar fallback for: "+b+", with tagId: "+l);e=aipAPItag.adSlots[b].cpmstar.width;f=aipAPItag.adSlots[b].cpmstar.height;l&&(document.getElementById(b).innerHTML="",g=document.createElement("iframe"),g.width=e,g.height=f,g.border="0px",g.hspace="0",g.vspace="0",g.marginWidth="0",g.marginHeight="0",g.style.border="0",g.scrolling="no",g.frameBorder="0",g.src="about:blank",document.getElementById(b).appendChild(g),g.contentDocument.write('\n\t\t\t\t\t\t\t\t\t\t<script async src="https://ssl.cdne.cpmstar.com/cached/js/lib.js">\x3c/script>\n\n\t\t\t\t\t\t\t\t\t\t<div class="div-'+
l+'" style="width:'+e+"px; height:"+f+'px"></div>\n\t\t\t\t\t\t\t\t\t\t<script>\n\t\t\t\t\t\t\t\t\t\t(function(w,pid){\n\t\t\t\t\t\t\t\t\t\tvar y = "cpmstarx", els = w.document.getElementsByClassName("div-"+pid), pindex = els.length-1, el = els[pindex];\n\t\t\t\t\t\t\t\t\t\tw[y]=w[y]||{};(w[y].libcmd=w[y].libcmd||[]).push({kind:\'asynctagfetch\',el:el,pid:pid,pindex:pindex});\n\t\t\t\t\t\t\t\t\t\t})(window,'+l+");\n\t\t\t\t\t\t\t\t\t\t\x3c/script>\n\t\t\t\t\t\t\t\t\t\t"))}else aipAPItag.log("empty slotId for: "+
b),c=!0}var p=new CustomEvent("slotRenderEnded",{detail:{adType:"display",slotId:b,isEmpty:c}});aiptag.events.dispatchEvent(p);p=new CustomEvent("aip_slotRenderEnded",{detail:{slotElementId:b,isEmpty:c}});document.dispatchEvent(p)}}catch(q){aipAPItag.logError(q)}})})))};function aipDisplay(){}aipDisplay.prototype.displayInit=function(){aiptag.settings.iPrebidAnalyticsByRoxot&&aip_pbjs.que.push(function(){aip_pbjs.enableAnalytics({provider:"roxot",options:{publisherIds:["511f1c27-5069-466f-b2f8-d21b9da3b540"]}})})};
...
aipDisplay.prototype.refreshTag=function(a){aipAPItag.queue_ready_display=!0;if(aipDisplayTag.getReload(a)){try{if(!aipAPItag.isInPage(document.getElementById(a))){var b=aipAPItag.adSlots[a].adunit;aipAPItag.sendLogDiv(b);console.warn("***WARNING*** could not find div with id "+b);if(aiptag.settings.iStopOnMissingDiv)return}}catch(h){}aipAPItag.cutomSizeConfig();aipAPItag.queue_ready_display=!1;aipAPItag.adUnitsLoaded[a]||(aipAPItag.adUnitsLoaded[a]="loaded",googletag.cmd.push(function(){aipAPItag.adSlot[a]=
googletag.defineSlot("/"+aiptag.settings.sNetworkIdDisplay+"/"+aipAPItag.adSlots[a].adunit,aipAPItag.adSlots[a].sizes,a).addService(googletag.pubads());aipAPItag.inIframe()&&googletag.pubads().set("page_url",window.location.protocol+"//"+window.location.host);googletag.enableServices();googletag.display(a);aipAPItag.log("AD SLOT DEFINED: "+a)}));aiptag.settings.iSizeMappingOnResize&&googletag.cmd.push(function(){try{var h=googletag.sizeMapping().addSize([0,0],aipAPItag.adSlots[a].sizes).build();aipAPItag.adSlot[a].defineSizeMapping(h)}catch(e){aipAPItag.logError(e)}});
aipAPItag.adUnitsRefreshed[a]||(aipAPItag.adUnitsRefreshed[a]=0);aipAPItag.adUnitsRefreshed[a]++;if(aiptag.settings.iDisableEvenAddRefresh&&0==aipAPItag.adUnitsRefreshed[a]%2)aipAPItag.log("AD REFRESH EVEN for: "+a);else{aiptag.settings.iLimitedAds&&googletag.cmd.push(function(){googletag.pubads().setPrivacySettings({limitedAds:!0});aipAPItag.log("Limited ads: "+a+" ad request marked with Limited ads status LTD=1")});aiptag.settings.iChildSafeAds&&googletag.cmd.push(function(){googletag.pubads().setTagForChildDirectedTreatment(1);
googletag.pubads().setPrivacySettings({childDirectedTreatment:!0});aipAPItag.log("COPPA: "+a+" ad request marked with a child-directed status tfcd=1")});aiptag.settings.iReloadisEmptyDisplay&&1===aipAPItag.adSlots[a].isEmptyReloadedCounter&&(aipAPItag.adSlots[a].isEmptyReloadedCounter=0,aipAPItag.log("EmptyAdRefresh=1 for: "+a),googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("EmptyAdRefresh","1")}));aipAPItag.inIframe()?(aipAPItag.log("iframe display AD, GS=Yes"),googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("GS",
"Yes")})):(aipAPItag.log("none iframe display Ad, GS=No"),googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("GS","No")}));aiptag.subid&&(aipAPItag.log("Custom SubID"),googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("subid",aiptag.subid)}));googletag.cmd.push(function(){try{var h=aipAPItag.adUnitsRefreshed[a].toString();aipAPItag.adSlot[a].setTargeting("FC",h);aipAPItag.log(a+", FC="+h)}catch(e){aipAPItag.logError(e)}});var c="Other";try{/(cros)/.test(window.navigator.userAgent.toLowerCase())&&
(c="ChromeOS")}catch(h){aipAPItag.logError(h)}googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("OS",c);aipAPItag.log("OS="+c)});try{b=aipAPItag.adSlots[a].adunit,!0===aipAPItag.getConfirmedClick(b)?(googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("Conc","Yes");aipAPItag.log("Confirmed click setTargeting Conc=Yes on "+b)}),aipAPItag.unsetConfirmedClick(b)):googletag.cmd.push(function(){aipAPItag.adSlot[a].setTargeting("Conc","No")})}catch(h){aipAPItag.logError(h)}aipDisplayTag.unsetReload(a);
setTimeout(aipDisplayTag.setReload.bind(null,a),aipAPItag.timeout_reload_display);aipDisplayTag.displaySetup(a);var d=aipAPItag.timeout_bid_display;aipAPItag.log("[AD REQUEST] slotRenderStarted: "+a+" - "+aipAPItag.adUnitsRefreshed[a]);aipAPItag.requestManager[a].adserverRequestSent=!1;aipAPItag.requestManager[a].prebid=!1;aipAPItag.requestManager[a].aps=!1;window.setTimeout(function(){aipDisplayTag.sendAdserverRequest(a)},d);aiptag.settings.prebidLoaded?aip_pbjs.que.push(function(){aip_pbjs.requestBids({timeout:d,
adUnits:aipAPItag.adUnits[a],adUnitCodes:[a],bidsBackHandler:function(h){try{aipAPItag.log("Targeting params:"),aipAPItag.log(aip_pbjs.getAdserverTargeting()),aipAPItag.log("All bid objects:"),aipAPItag.log(JSON.stringify(aip_pbjs.getBidResponses()))}catch(e){aipAPItag.logError(e)}googletag.cmd.push(function(){aip_pbjs.setTargetingForGPTAsync([a]);aipAPItag.requestManager[a].prebid=!0;aipDisplayTag.biddersBack(a);aipAPItag.log("prebid biddersBack - "+a)})}})}):(aipAPItag.requestManager[a].prebid=
!0,aipDisplayTag.biddersBack(a));aiptag.settings.iAmazonDisplayAds&&apstag.fetchBids({slots:aipAPItag.adUnitsAps[a],timeout:d},function(h){googletag.cmd.push(function(){apstag.setDisplayBids();aipAPItag.requestManager[a].aps=!0;aipAPItag.log("aps biddersBack - "+a);aipDisplayTag.biddersBack(a)})})}}else aipAPItag.log("AD REFRESH called to soon for: "+a),aipDisplayTag.nextQueue()};
...
aipPlayer.prototype.getBidPrerollTag=function(a){aip_pbjs.que.push(function(){aipAPItag.prerollBidCpm.unruly=.87;if(aiptag.settings.sCustomPrerollBidCpmAdjustment){var b=aiptag.settings.sCustomPrerollBidCpmAdjustment;for(key in b)b[key][slotId]&&(aipAPItag.log("Custom Preroll Bid adjust "+key+" for: "+slotId+" with value: "+b[key][slotId]),aipAPItag.prerollBidCpm[key]=b[key][slotId])}aip_pbjs.bidderSettings={standard:{storageAllowed:!0},unruly:{bidCpmAdjustment:function(c,d){aipAPItag.log("Preroll Bid adjust for: "+
d.bidderCode);return c*aipAPItag.prerollBidCpm.unruly}}};aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aipAPItag.inIframe()&&aip_pbjs.setConfig({pageUrl:window.location.protocol+"//"+window.location.host});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:1E3,filterSettings:{all:{bidders:"*",filter:"include"}},syncDelay:100},cache:{url:"https://prebid.adnxs.com/pbc/v1/cache"},bidderTimeout:aipAPItag.timeout_bid_player,enableSendAllBids:!1,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,
...
aiptag.settings.iChildSafeAds&&(b.tfcd="1",aipAPItag.log("COPPA: video ad request marked with a child-directed status tfcd=1"));aiptag.settings.iLimitedAds&&(b.LTD="1",aipAPItag.log("Limited ads: video ad request marked with Limited ads status LTD=1"));a=Object.keys(b).map(function(c){return c+"%3D"+b[c]}).join("%26");!1!==aipAPItag.requestManagerPreroll.apsBid&&(a+=aipAPItag.requestManagerPreroll.apsBid);if(a)try{this.aipConfig.AD_TAG=aipAPItag.urlParamUpdate(this.aipConfig.AD_TAG,"cust_params",
...
function AipAds(a,b,c,d){function h(){aipAPItag.sendEvent("video-ad-paused");a.addAipPauseButton();try{document.getElementById("aipPauseButtonContainer").addEventListener("click",e)}catch(m){aipAPItag.logError(m)}try{!0===aiptag.settings.iIframeFocusFix&&"IFRAME"===document.activeElement.tagName&&document.activeElement.blur()}catch(m){aipAPItag.logError(m)}}function e(){aipAPItag.sendEvent("video-ad-unpaused");v.resume();try{document.getElementById("aipPauseButtonContainer").style.display="none"}catch(r){aipAPItag.logError(r)}try{document.getElementById("aipPauseButtonContainer").removeEventListener("click",
e)}catch(r){aipAPItag.logError(r)}try{var m=document.getElementById("aipPauseButtonContainer");m.parentNode.removeChild(m)}catch(r){aipAPItag.logError(r)}}function f(){aipAPItag.sendEvent("video-ad-resumed")}function g(m){B("EXCEPTION",{name:m.name,message:m.message,stack:m.stack})}function l(m){var r="",u="",z="";try{r=m.getAd().getContentType(),u=m.getAd().getMinSuggestedDuration(),z=m.getAd().getCreativeId(),prerollSkipTimeOffset=m.getAd().getSkipTimeOffset()}catch(E){g(E)}B("CONTENT_PAUSE_REQUESTED",
{contentType:r,creativeId:z,minSuggestedDuration:u})}function p(m){A();c.style.display="block";a.showLoading(!1,!1);a.aipConfig.AIP_STARTED&&a.aipConfig.AIP_STARTED();try{switch(m.getAd().getContentType().split("/")[0]){case "audio":a.showLoading(!0,!1,"audio")}}catch(r){aipAPItag.logError(r)}try{aipAPItag.forceRedraw(document.getElementById(a.aipConfig.PREROLL_ELEM_ID))}catch(r){aipAPItag.logError(r)}if(d)try{B("MediaUrl: "+m.getAd().getMediaUrl()+"; AdvertiserName: "+m.getAd().getAdvertiserName()+
"; Description: "+m.getAd().getDescription()+"; Title: "+m.getAd().getTitle())}catch(r){g(r)}B("STARTED");aipAPItag.sendEvent("video-ad-started");aiptag.settings.iSkipButtonTimeout&&(aipAPItag.showSkipButtonTimer=setTimeout(function(){a.showSkipButton();try{document.getElementById("aipVideoAdUiSkipButton").onclick=function(){t()}}catch(r){aipAPItag.logError(r)}},aiptag.settings.iSkipButtonTimeout))}function q(m){try{var r=m%60;return y(Math.floor(m/60),1)+":"+y(r,2)}catch(u){return m}}function y(m,
r){try{var u="000000000"+m;return u.substr(u.length-r)}catch(z){return m}}function n(m){try{var r=m.getAdData();if(parseInt(r.currentTime)>=parseInt(r.duration))setTimeout(function(){try{document.getElementById("duration-text-aip").innerHTML="",a.showCloseButton(),document.getElementById("aipVideoAdUiCloseButton").onclick=function(){t()}}catch(z){}},2E3);else if(30<parseInt(r.duration)){var u=30-parseInt(r.currentTime);document.getElementById("duration-text-aip").innerHTML=u+"s to close";0>=u&&(document.getElementById("duration-text-aip").innerHTML=
"",a.showCloseButton(),document.getElementById("aipVideoAdUiCloseButton").onclick=function(){t()})}else document.getElementById("duration-text-aip").innerHTML=q(parseInt(r.currentTime))+" / "+q(parseInt(r.duration))}catch(z){}}function x(){B("CONTENT_RESUME_REQUESTED");D=!1;H("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}function t(){v.skip();v&&v.destroy();B("CONTENT_RESUME_REQUESTED");D=!1;H("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}function w(m){A();B(m.getError());
v&&v.destroy();var r=(new Date).getTime()-K;1012==m.getError().getErrorCode()&&0<=r&&800>r?(B("AD BLOCKED",{timeElapsed:r}),a.aipConfig.AIP_BLOCKED&&a.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock"),m="user-has-adblock"):m.getError().getErrorCode()==google.ima.AdError.ErrorCode.VAST_EMPTY_RESPONSE||901==m.getError().getErrorCode()&&m.getError().getInnerError()&&"Error: No ads available"==m.getError().getInnerError().message?(B("NO ADS",{errorCode:m.getError().getErrorCode(),message:m.getError().getMessage(),
innerError:m.getError().getInnerError(),vastErrorCode:m.getError().getVastErrorCode(),timeElapsed:r}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-empty"),m="video-ad-empty"):(B("ERROR",{errorCode:m.getError().getErrorCode(),message:m.getError().getMessage(),innerError:m.getError().getInnerError(),vastErrorCode:m.getError().getVastErrorCode(),timeElapsed:r}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-error"),m="video-ad-error");D=!1;
H(m)}function F(){J=!0;D=!1;v&&v.destroy();B("TIMEOUT");H("video-ad-timeout");aipAPItag.sendEvent("video-ad-timeout")}function A(){I&&(clearTimeout(I),I=null)}function H(m){try{clearTimeout(aipAPItag.completedTimeoutPreroll)}catch(z){aipAPItag.logError(z)}if(aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer)}catch(z){aipAPItag.logError(z)}try{var r=document.getElementById("aipBranding");if("undefined"!=typeof r&&null!=r){var u=document.getElementById("aipBranding");
u.parentNode.removeChild(u)}}catch(z){aipAPItag.logError(z)}A();a.aipComplete(m)}function L(){a.aipConfig.AD_FULLSCREEN?(windowWidth=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,windowHeight=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight,aiptag.settings.iHideBranding||(windowHeight-=26)):a.aipConfig.AD_FILL?(windowWidth=a.aipConfig.PREROLL_CONTAINER.clientWidth,windowHeight=a.aipConfig.PREROLL_CONTAINER.clientHeight,aiptag.settings.iHideBranding||
(windowHeight-=26)):(windowWidth=b.offsetWidth,windowHeight=b.offsetHeight);return{adWidth:windowWidth,adHeight:windowHeight}}var G,v,D,K,I,J,B=function(){};window.addEventListener("error",function(m){if(D)try{B("WINDOW_EXCEPTION",{name:"WindowErrorListener: "+m.error.toString(),message:m.error.toString(),stack:m.error.stack})}catch(r){aipAPItag.logError(r)}});(function(){var m=new google.ima.AdDisplayContainer(c);m.initialize();G=new google.ima.AdsLoader(m);G.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);
G.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(r){function u(C){return function(){"COMPLETE"==C&&(aipAPItag.sendEvent("video-ad-completed"),aipAPItag.completedTimeoutPreroll=setTimeout(x,1500));"CLICK"==C&&aipAPItag.sendEvent("video-ad-clicked");"USER_CLOSE"==C&&aipAPItag.sendEvent("video-ad-close");"LOADED"==C&&(aipAPItag.sendEvent("video-ad-loaded"),aipAPItag.prerollSkipped=!1);"SKIPPED"==C&&(aipAPItag.sendEvent("video-ad-skipped"),aipAPItag.prerollSkipped=
!0);if("SKIPPABLE_STATE_CHANGED"==C&&aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer),document.getElementById("aipVideoAdUiSkipButton").style.display="none"}catch(M){aipAPItag.logError(M)}B(C);aipAPItag.log("Preroll status: "+C)}}if(!J){var z=new google.ima.AdsRenderingSettings;z.loadVideoTimeout=aiptag.settings.iTimeoutPlayer;v=r.getAdsManager(b,z);v.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,w);v.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,
l);v.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,x);v.addEventListener(google.ima.AdEvent.Type.STARTED,p);v.addEventListener(google.ima.AdEvent.Type.AD_PROGRESS,n);v.addEventListener(google.ima.AdEvent.Type.SKIPPED,u("SKIPPED"));v.addEventListener(google.ima.AdEvent.Type.CLICK,u("CLICK"));v.addEventListener(google.ima.AdEvent.Type.PAUSED,h);v.addEventListener(google.ima.AdEvent.Type.RESUMED,f);v.addEventListener(google.ima.AdEvent.Type.FIRST_QUARTILE,u("FIRST_QUARTILE"));v.addEventListener(google.ima.AdEvent.Type.MIDPOINT,
u("MIDPOINT"));v.addEventListener(google.ima.AdEvent.Type.THIRD_QUARTILE,u("THIRD_QUARTILE"));v.addEventListener(google.ima.AdEvent.Type.LOADED,u("LOADED"));v.addEventListener(google.ima.AdEvent.Type.COMPLETE,u("COMPLETE"));v.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,u("USER_CLOSE"));v.addEventListener(google.ima.AdEvent.Type.SKIPPABLE_STATE_CHANGED,u("SKIPPABLE_STATE_CHANGED"));try{var E=L();a.aipConfig.AD_FULLSCREEN||a.aipConfig.AD_FILL?v.init(E.adWidth,E.adHeight,google.ima.ViewMode.FULLSCREEN):
v.init(E.adWidth,E.adHeight,google.ima.ViewMode.NORMAL);v.start()}catch(C){g(C)}}});G.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,w)})();window.addEventListener("resize",function(){if(v&&D)if(a.aipConfig.AD_FULLSCREEN){var m=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,r=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight;aiptag.settings.iHideBranding||(r-=26);v.resize(m,r,google.ima.ViewMode.FULLSCREEN)}else a.aipConfig.AD_FILL&&
(m=a.aipConfig.PREROLL_CONTAINER.clientWidth,r=a.aipConfig.PREROLL_CONTAINER.clientHeight,aiptag.settings.iHideBranding||(r-=26),v.resize(m,r,google.ima.ViewMode.FULLSCREEN))});this.requestAds=function(m,r){B=r;K=(new Date).getTime();var u=new google.ima.AdsRequest;aipAPItag.log("Final vasturl="+m);u.adTagUrl=m;aipAPItag.inIframe()&&(u.pageUrl=window.location.href);var z=L();u.linearAdSlotWidth=z.adWidth;u.linearAdSlotHeight=z.adHeight;u.nonLinearAdSlotWidth=z.adWidth;u.nonLinearAdSlotHeight=z.adHeight;
u.forceNonLinearFullSlot=!0;u.setAdWillAutoPlay(!1);u.setAdWillPlayMuted(!1);G.requestAds(u);I=setTimeout(F,aiptag.settings.iTimeoutPlayer);J=!1;D=!0}}
function AipAudioAds(a,b){function c(n){var x=n.getAd();x&&(currentAd=x);switch(n.type){case google.ima.AdEvent.Type.LOADED:try{"audio"!=n.getAd().getContentType().split("/")[0]&&(p&&p.destroy(),d())}catch(A){}break;case google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED:a.aipConfig.AIP_AUDIOADSTART&&a.aipConfig.AIP_AUDIOADSTART();break;case google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED:n.getAd().getContentType();d();break;case google.ima.AdEvent.Type.PAUSED:a.addAipPauseButtonCss();var t=document.getElementById("aipAudioPauseButtonContainer");
if("undefined"==typeof t||null==t)t=document.createElement("div"),t.id="aipAudioPauseButtonContainer",t.style.overflow="hidden",t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.bottom="0",t.style.right="0",t.style.zIndex="999999",t.style.width="100%",t.style.height="100%",t.innerHTML='<div class="aipAudioPauseButton" id="aipPauseButton"></div><div id="aipPauseButtonBG"></div>',document.getElementById("aipAudioAds").appendChild(t);t.style.display="block";try{document.getElementById("aipAudioPauseButtonContainer").addEventListener("click",
h)}catch(A){aipAPItag.logError(A)}break;case google.ima.AdEvent.Type.AD_PROGRESS:n=n.getAdData();document.getElementById("aipAudioAds").style.display="block";x=document.getElementById("aipAudioAdsDuration");var w=parseInt(n.duration-n.currentTime);try{var F=w%60;t=f(Math.floor(w/60),1)+":"+f(F,2)}catch(A){t=w}x.innerHTML="AUDIO AD "+t;document.getElementById("aipAudioAds").style.display="block";x=n.currentTime;w=currentAd.getSkipTimeOffset();n=-1!==w;t=p.getAdSkippableState();x=Math.ceil(w-x);n?(document.getElementById("aipAudioAdUiSkipButton").style.display=
"inline",n=document.getElementById("aipAudioAdSkipButton"),t?(n.textContent="Skip ad",n.disabled=!1,n.style.color="#dddddd"):(n.textContent="Skip ad ("+x+")",n.disabled=!0,n.style.color="#666666")):document.getElementById("aipAudioAdUiSkipButton").style.display="none"}}function d(){document.getElementById("aipAudioAds").style.display="none";try{document.getElementById("aipAudioPauseButtonContainer").style.display="none"}catch(x){}try{var n=document.getElementById("aipAudioPauseButtonContainer");n.parentNode.removeChild(n)}catch(x){}a.aipConfig.AIP_AUDIOADCOMPLETE&&
a.aipConfig.AIP_AUDIOADCOMPLETE()}function h(){p.resume();try{document.getElementById("aipAudioPauseButtonContainer").style.display="none"}catch(x){}try{document.getElementById("aipAudioPauseButtonContainer").removeEventListener("click",h)}catch(x){}try{var n=document.getElementById("aipAudioPauseButtonContainer");n.parentNode.removeChild(n)}catch(x){}}function e(){var n=document.getElementById("aipAudioAds");"undefined"==typeof n||null==n?(n=document.createElement("div"),n.id="aipAudioAds",n.style.position=
"fixed",n.style.display="none",n.style.bottom="0",n.style.right="0",n.style.zIndex="999998",n.innerHTML='\n\t\t\t<div style="font-family: Roboto, Arial, Helvetica, sans-serif;padding-left: 6px;text-align: left;min-height: 25px;background-color: #000000;position: relative;border-radius: 4px 0px 0px 4px;">\n\t\t\t\t<div id="aipAudioAdUiSkipButton" style="display:none">\n\t\t\t\t\t<button id="aipAudioAdSkipButton" style="font-family: Roboto, Arial, Helvetica, sans-serif;padding: 0;border:0;background: rgba(0,0,0,0.8);color: #ddd;cursor: pointer;font-size: 14px;"></button>\n\t\t\t\t\t<span style="color: #ddd"> | </span>\n\t\t\t\t</div>\n\t\t\t\t<span id="aipAudioAdsDuration" style="font-size: 13px;font-family: Roboto,Arial,Helvetica,sans-serif;font-weight: 100;color: #ddd;line-height: 25px;"></span>\n\t\t\t\t<a style="float: right" href="https://adinplay.com/?utm_source=publishers&utm_medium=websites&utm_campaign=AudioAd" target="_blank"><img style="display: block;margin-right: 5px;margin-left: 5px;margin-top: 5px;" border="0" id="aipLogo" src="data:image/png;base64,"></a>\n\t\t\t\t<audio id="aipAudioElement"></audio>\n\t\t\t</div>\n\t\t\t',
document.getElementsByTagName("body")[0].appendChild(n),skipButton=document.getElementById("aipAudioAdSkipButton"),skipButton.addEventListener("click",function(){p.skip()})):n.style.display="block";q=document.getElementById("aipAudioElement")}function f(n,x){try{var t="000000000"+n;return t.substr(t.length-x)}catch(w){return n}}function g(n){aipAPItag.log(n.getError());p&&p.destroy();d()}var l,p,q,y=function(){};(function(){e();var n=new google.ima.AdDisplayContainer(q);n.initialize();l=new google.ima.AdsLoader(n);
l.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);l.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(x){var t=new google.ima.AdsRenderingSettings;t.loadVideoTimeout=aiptag.settings.iTimeoutPlayer;p=x.getAdsManager(q,t);p.addEventListener(google.ima.AdEvent.Type.LOADED,c);p.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,c);p.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,c);p.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED,
c);p.addEventListener(google.ima.AdEvent.Type.COMPLETE,c);p.addEventListener(google.ima.AdEvent.Type.AD_PROGRESS,c);p.addEventListener(google.ima.AdEvent.Type.PAUSED,c);try{p.init("0","0",google.ima.ViewMode.NORMAL),p.start()}catch(w){y("EXCEPTION",{name:w.name,message:w.message,stack:w.stack})}});l.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,g)})();this.requestAds=function(n,x){y=x;(new Date).getTime();var t=new google.ima.AdsRequest;aipAPItag.log("Final audio vasturl="+n);t.adTagUrl=
n;aipAPItag.inIframe()&&(t.pageUrl=window.location.href);t.linearAdSlotWidth=0;t.linearAdSlotHeight=0;t.nonLinearAdSlotWidth=0;t.nonLinearAdSlotHeight=0;t.forceNonLinearFullSlot=!0;t.setAdWillAutoPlay(!1);t.setAdWillPlayMuted(!1);l.requestAds(t)}}aipAPItag=new aipAPI;aipAPItag.consoleAd();aipAPItag.log("aiplib last updated: "+aiptag.settings.sUpdated);aipAPItag.initLoadTag();aipAPItag.cutomSizeConfig();aipAPItag.setCurrency();aipAPItag.initGDPR();aipAPItag.initLibs();aipAPItag.detectBlockedAds();
aipAPItag.stats();
